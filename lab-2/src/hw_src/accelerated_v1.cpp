...
*
* HLS INLINE: Forces function to be inlined at call site for zero overhead
*/
...
* The sharpen filter can produce negative values (when neighbors are brighter)
* or values > 255 (when center is much brighter than neighbors).
*
